...
# Generated on: Sat Jul 25 12:02:36 -03 2026 (Sat Jul 25 15:02:36 UTC 2026)
...
set logfile fv/x3_curto/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/x3_curto -revised fv_map -use_rtl_names
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k x3_curto.v
elaborate_design -golden -root {x3_curto} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/x3_curto/fv_map.v.gz
elaborate_design -revised -root {x3_curto}
...
set_analyze_option -mapping_file fv/x3_curto/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.x3_curto.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.x3_curto.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.x3_curto.rtl.fv_map.rpt
