...
# Generated on: Sat Jul 25 15:22:38 -03 2026 (Sat Jul 25 18:22:38 UTC 2026)
...
set logfile fv/mac_param/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mac_param -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /home/cidigital/projects/aulas-ci-digital/aula_25_07/LAB02/E2/../LIB/fast_vdd1v0_basicCells.lib \
    /home/cidigital/projects/aulas-ci-digital/aula_25_07/LAB02/E2/../LIB/slow_vdd1v0_basicCells.lib
...
elaborate_design -golden -root {mac_param} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/mac_param/fv_map.v.gz
elaborate_design -revised -root {mac_param}
...
set_analyze_option -mapping_file fv/mac_param/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.mac_param.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mac_param.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mac_param.rtl.fv_map.rpt
