...
# Generated on: Sat Aug 22 09:49:46 -03 2026 (Sat Aug 22 12:49:46 UTC 2026)
...
set logfile fv/pattern_detector/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/pattern_detector -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/apps/cds/installs/DDI251/GENUS251/tools.lnx86"
set CDN_SYNTH_ROOT      "/apps/cds/installs/DDI251/GENUS251/tools.lnx86"
set env(CW_DIR) "/apps/cds/installs/DDI251/GENUS251/tools.lnx86/lib/chipware"
set CW_DIR      "/apps/cds/installs/DDI251/GENUS251/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /apps/cds/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/apps/cds/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/apps/cds/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/apps/cds/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/apps/cds/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
}
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k mac_param.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k buffer.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k fsm.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k pattern_detector.v
elaborate_design -golden -root {pattern_detector} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/pattern_detector/fv_map.v.gz
elaborate_design -revised -root {pattern_detector}
...
set_analyze_option -mapping_file fv/pattern_detector/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.pattern_detector.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.pattern_detector.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.pattern_detector.rtl.fv_map.rpt
