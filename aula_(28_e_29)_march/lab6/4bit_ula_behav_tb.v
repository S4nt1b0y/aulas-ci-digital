module moduleName;
    ...
    initial begin
        ...
        // =============================
        A = 4'b0101; B = 4'b0101; seletor = 3'b100; #1;
        if(resultado == 4'b1010) $display("RESULTADO NÃO ZERO"); // exemplo normal


        A = 4'b0110; B = 4'b1010; seletor = 3'b100; #1;
        if(Z == 0) $display("Z correto"); 

        A = 4'b0000; B = 4'b0000; seletor = 3'b000; #1;
        if(Z == 1) $display("PASSOU teste Z=1");
        $display("Flags: C=%b V=%b Z=%b N=%b", C, V, Z, N);

        A = 4'b1000; B = 4'b0000; seletor = 3'b010; #1;
        ...
        // Teste 11: Shift Left
        // =============================
        A = 4'b0011; B = 4'b0010; seletor = 3'b110; #1;
        ...
        // =============================
        A = 4'b1100; B = 4'b0010; seletor = 3'b111; #1;
