...
# Generated on: Sat Sep 05 13:53:51 -03 2026 (Sat Sep 05 16:53:51 UTC 2026)
...
set logfile fv/mac_lab9_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mac_lab9_top -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/cadence/GENUS25.13/tools.lnx86"
set CDN_SYNTH_ROOT      "/cadence/GENUS25.13/tools.lnx86"
set env(CW_DIR) "/cadence/GENUS25.13/tools.lnx86/lib/chipware"
set CW_DIR      "/cadence/GENUS25.13/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /cadence/GENUS25.13/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/cadence/GENUS25.13/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/cadence/GENUS25.13/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/cadence/GENUS25.13/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/cadence/GENUS25.13/tools.lnx86/lib/chipware/sim"
}
...
add_search_path ../aula_21_08/LAB9/LIB/ -library -both
read_library -liberty -both \
    /mnt/c/Users/gusta/projects/aulas-ci-digital/aula_04_09/../aula_21_08/LAB9/LIB/slow_vdd1v0_basicCells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k mac_param.v mac_lab9_top.v
elaborate_design -golden -root {mac_lab9_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mac_lab9_top/fv_map.v.gz
elaborate_design -revised -root {mac_lab9_top}
...
set_analyze_option -mapping_file fv/mac_lab9_top/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.mac_lab9_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mac_lab9_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mac_lab9_top.rtl.fv_map.rpt
