...
build_model \
    -cell	 mac_lab9_top \
    -techlib	 ../aula_21_08/LAB9/LIB/slow_vdd1v0_basiccells.v \
    -designsource	 $WORKDIR/mac_lab9_top.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/mac_lab9_top.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 mac_lab9_top_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \
