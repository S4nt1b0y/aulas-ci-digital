...
# Generated on: Sat Aug 22 16:04:21 -03 2026 (Sat Aug 22 19:04:21 UTC 2026)
...
set logfile fv/aFifo/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/aFifo -revised fv_map -use_rtl_names
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k GrayCounter.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k aFifo.v
elaborate_design -golden -root {aFifo} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/aFifo/fv_map.v.gz
elaborate_design -revised -root {aFifo}
...
set_analyze_option -mapping_file fv/aFifo/fv_map.map.do
...
write_compared_points noneq.compared_points.aFifo.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.aFifo.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.aFifo.rtl.fv_map.rpt
