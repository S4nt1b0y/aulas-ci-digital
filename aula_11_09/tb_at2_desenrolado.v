...
module tb_at2_desenrolado;
    ...
    initial begin
        $dumpfile("tb_at2_desenrolado.vcd");
        $dumpvars(0, tb_at2_desenrolado);
        ...
        apply_and_check(8'd7);

        if (errors == 0)
            $display("tb_at2_desenrolado: PASS");
        else
            $display("tb_at2_desenrolado: FAIL com %0d erro(s)", errors);
